...
if (v != null) {
        ...
        if (notToken != null) {
             if ((op != null && op.getType() != Type.BOOL)) {if (true) throw new IncompatibleTypeException(Type.BOOL, op.getType());}
             if ((v != null && v.getType() != Type.BOOL)) {if (true) throw new IncompatibleTypeException(Type.BOOL, v.getType());}
        }
