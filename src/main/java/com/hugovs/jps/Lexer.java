...
/*Command CMD_FOR():
    {
        ...
        <CMD_FOR> <LPAREN> VAR_LIST() <SEMICOLON> EXPRESSION() <SEMICOLON> VAR_LIST()
    ){
...
if (exp.getType() != Type.STRING)
            {if (true) throw new IncompatibleTypeException(Type.STRING, exp.getType());}
